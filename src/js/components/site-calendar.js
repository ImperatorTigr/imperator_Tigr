...
const EVENTS=[
    ...
    {date:"2026-05-31",title:"Личная дата - 50,50 лет. Принято решение о старте проявленности в публичной сфере."},
    {date:"2026-08-14",title:"Практика \"ИСПЕПЕЛЕНИЕ\" (для участников игры Деньги просто деньги)"},
    {date:"2026-07-21",title:"Практика дня - Деньги просто деньги."},
    {date:"2026-10-10",title:"День СИЛы. Ведется подготовка мероприятий..."},
    {date:"2026-12-30",title:"День рождения. Принимаются пожелания и подарки. Всем буду рад."}
